...
| Water quality / sewage context | `/docs/specs/discovery/water-quality.md` | Queued | Spec drafted from the July 2026 market review; near-real-time spill status (National Storm Overflow Hub) + EA bathing classifications tied to put-ins/reaches, framed as risk context. Recommended cold-start lever — no build started. |
