...
| PLATFORM-F13 | Hosted Firebase Auth flow | Ops/auth | Active | v0.3 | — | Hosted web builds use popup sign-in with the Firebase project helper domain while custom-domain redirect sign-in is stabilised. |
