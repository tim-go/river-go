...
**Scope:** The runnable frontend prototype used to validate RiffleMap.com's section map, dam-release Tryweryn sample, and community contribution workflow.

## Purpose

The demo prototype exists to validate RiffleMap.com's product shape before backend investment. It lets paddlers understand a real river section, inspect map-based river knowledge, and test the community contribution flow.

The demo is not yet a production app. It uses seeded data and local browser persistence.

## Product Role

- `Primary user objective:` Understand whether RiffleMap.com's section-first map and contribution model would help plan and refresh river knowledge.
- `Classification:` Core
...
- show a left-hand river section list
...
The public app brand is RiffleMap.com. Internal repo, GCP, Firebase, and deployment IDs remain `river-go`.
...
| DEMO-F8 | RiffleMap.com public brand | App shell | Active | prototype | — | Visible app title and browser title use RiffleMap.com while internal IDs remain `river-go`. |
...
| 2026-05-23 | Updated public app brand to RiffleMap.com. |
