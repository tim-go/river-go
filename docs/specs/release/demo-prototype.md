...
**Scope:** The runnable frontend prototype used to validate RiverLaunch.app's section map, dam-release Tryweryn sample, and community contribution workflow.
...
- `Primary user objective:` Understand whether RiverLaunch.app's section-first map and contribution model would help plan and refresh river knowledge.
- `Classification:` Core
